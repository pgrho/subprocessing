...
{
    /// <summary>
    /// <see cref="T:Shipwreck.Subprocessing.ServiceSubprocessHost`1" />のサブプロセス起動情報の基底クラスです。
    /// </summary>
    ...
    public abstract class ServiceSubprocessStartInfoBase<TUserService, TGeneratedService, TParameter>
        : IServiceSubprocessStartInfo<TUserService, TParameter>
        ...
        where TGeneratedService : class
    {
        ...
        /// </summary>
        private sealed class Client : ClientBase<TGeneratedService>
        {
            /// <summary>
        ...
        /// <summary>
        /// <see cref="T:Shipwreck.Subprocessing.Emit.ServiceSubprocessStartInfoBase`3" />クラスの新しいインスタンスを初期化します。
        /// </summary>
        /// <param name="argument">サブプロセスに渡された起動引数。</param>
        public ServiceSubprocessStartInfoBase(SubprocessArgument<TParameter> argument)
        {
